...
<!-- The database column location has been changed its name to department if you have been using my previous files -->
    <div class="container">
        ...
        ?>
            ...
            <!-- add a row with a link to a php page. The link is appended with a query which contains the record unique id -->            
              ...
              <td><a href="delete.php?employee_id=<?php echo $row['employee_id']?>">Update</a></td> 
